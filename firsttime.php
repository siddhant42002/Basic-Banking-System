...
$sql ="INSERT INTO `bank`.`customers` (`Cust_ID`, `Name`, `Email`, `Amount`) 
    VALUES ('1', 'Paddy', 'Paddy@yahoo.com', '3000.00'), 
    ('2', 'Gund', 'Gund@orkut.com', '10000.00'), 
    ('3', 'Auti', 'Auti@outlook.com', '5000.00'), 
    ('4', 'Jay', 'Jay@gmail.com', '15000.00'), 
    ('5', 'Rushi', 'Rushi@rediff.com', '20000.00'), 
    ('6', 'Pratik', 'Pratik@xyz.com', '3500.00'), 
    ('7', 'rahul', 'rahul@abc.com', '12000.00'), 
    ('8', 'Shakur', 'Shakur@123.com', '30000.00'), 
    ('9', 'Nikhil', 'Nikhil@gmail.com', '23000.00'), 
    ('10', 'Santosh', 'Santosh@def.com', '40000.00')";
